...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{ asset(AppHelper::getConfigPath('iCheck').'blue.css') }}">
...
<div class="login-box">
    ...
    <div class="login-box-body">
        <p class="login-box-msg">Sign in to start your session</p>
            <form method="POST" action="{{ url('/admin-panel') }}">
                {{ csrf_field() }}
...
<!-- iCheck -->
<script src="{{ asset(AppHelper::getConfigPath('iCheck').'icheck.min.js') }}"></script>
<script>
    $(function () {
        $('input').iCheck({
